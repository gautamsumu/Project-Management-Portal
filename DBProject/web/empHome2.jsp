...
//------------------------------------------------------------------------------------------------------------
	    function display_projects(){
                ...
                $.ajax({type:"POST", url:"GetTask",  data:"task_id="+"-99", success:function(data) {
                        //do nothing
                            var arr=data.split(";");
                            var ctr=0;
                            ...
                            for(var x=0;x<status.length;x++){
                                    ...
                                    document.getElementById("activity").innerHTML+="<div class='projectdetails' title='"+titles[x]+"'><span class='para'>Task "+ids[x]+": "+titles[x]+" ("+deadlines[x]+")</span><div id='create' style='float:right'><form method='post' action='markComplete' onsubmit='markComplete'><input type='hidden' name='id' value='"+ids[x]+"' /><input type='hidden' name='type' value='0' />     <input type='submit' value='Submit' "+submit+"/><input type='submit' formaction='deleteTask' value='Delete' "+erase+"/></form></span></div>";
                            }
                        }
                });
	    }
...
<body style="background-color:#f3f3f3;">
	<div id="wrapper">
		<div class="left">
			...
			<div id="navigation">
			    ...
			    <div>
			        ...
			        <p>
                                    <a href='#' onclick='display_sent()'>Sent Messages</a>
			        </p>
			    </div>
			    <h3>Profile</h3>
			    <div>
		...
		<div id ="projects" class="right" style="display:block">
